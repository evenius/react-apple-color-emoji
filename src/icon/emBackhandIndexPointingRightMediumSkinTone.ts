...
const definition = {
  icon: import("../webp/emoji_u1f449_1f3fd.webp"),
  name: "BackhandIndexPointingRightMediumSkinTone",
  aliases: ["backhand index pointing right: medium skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f449_1f3fd",
