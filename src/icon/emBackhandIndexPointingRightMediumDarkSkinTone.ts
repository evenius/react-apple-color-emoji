...
const definition = {
  icon: import("../webp/emoji_u1f449_1f3fe.webp"),
  name: "BackhandIndexPointingRightMediumDarkSkinTone",
  aliases: ["backhand index pointing right: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f449_1f3fe",
