...
const definition = {
  icon: import("../webp/emoji_u1f3ca_200d_2642_fe0f.webp"),
  name: "ManSwimming",
  aliases: ["man swimming","man_swimming","sports","exercise","human","athlete","water","summer"],
  width: 160,
  height: 160,
  unicode: "u1f3ca_200d_2642_fe0f",
