...
const definition = {
  icon: import("../webp/emoji_u1f9d1_1f3fb_200d_1f37c.webp"),
  name: "PersonFeedingBabyLightSkinTone",
  aliases: ["person feeding baby: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_1f3fb_200d_1f37c",
