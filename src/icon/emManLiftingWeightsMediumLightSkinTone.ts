...
const definition = {
  icon: import("../webp/emoji_u1f3cb_1f3fc_200d_2642_fe0f.webp"),
  name: "ManLiftingWeightsMediumLightSkinTone",
  aliases: ["man lifting weights: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f3cb_1f3fc_200d_2642_fe0f",
