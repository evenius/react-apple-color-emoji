...
const definition = {
  icon: import("../webp/emoji_u1f64d_200d_2640_fe0f.webp"),
  name: "WomanFrowning",
  aliases: ["woman frowning","woman_frowning","female","girl","woman","sad","depressed","discouraged","unhappy"],
  width: 160,
  height: 160,
  unicode: "u1f64d_200d_2640_fe0f",
