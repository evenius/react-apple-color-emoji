...
const definition = {
  icon: import("../webp/emoji_u1f486_1f3fc.webp"),
  name: "PersonGettingMassageMediumLightSkinTone",
  aliases: ["person getting massage: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f486_1f3fc",
