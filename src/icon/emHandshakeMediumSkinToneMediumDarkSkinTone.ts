...
const definition = {
  icon: import("../webp/emoji_u1faf1_1f3fd_200d_1faf2_1f3fe.webp"),
  name: "HandshakeMediumSkinToneMediumDarkSkinTone",
  aliases: ["handshake: medium skin tone, medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1faf1_1f3fd_200d_1faf2_1f3fe",
