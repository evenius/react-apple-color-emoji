...
const definition = {
  icon: import("../webp/emoji_u1f469_1f3ff_200d_1f3ed.webp"),
  name: "WomanFactoryWorkerDarkSkinTone",
  aliases: ["woman factory worker: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f469_1f3ff_200d_1f3ed",
