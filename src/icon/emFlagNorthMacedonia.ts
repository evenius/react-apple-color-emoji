...
const definition = {
  icon: import("../webp/emoji_u1f1f2_1f1f0.webp"),
  name: "FlagNorthMacedonia",
  aliases: ["flag: North Macedonia","flag_north_macedonia","macedonia","flag","nation","country","banner","north_macedonia"],
  width: 160,
  height: 160,
  unicode: "u1f1f2_1f1f0",
