...
const definition = {
  icon: import("../webp/emoji_u1f9d1_1f3fb_200d_1f9b1.webp"),
  name: "PersonLightSkinToneCurlyHair",
  aliases: ["person: light skin tone, curly hair"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_1f3fb_200d_1f9b1",
