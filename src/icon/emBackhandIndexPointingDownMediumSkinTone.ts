...
const definition = {
  icon: import("../webp/emoji_u1f447_1f3fd.webp"),
  name: "BackhandIndexPointingDownMediumSkinTone",
  aliases: ["backhand index pointing down: medium skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f447_1f3fd",
