...
const definition = {
  icon: import("../webp/emoji_u1f9d8_1f3fc.webp"),
  name: "PersonInLotusPositionMediumLightSkinTone",
  aliases: ["person in lotus position: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9d8_1f3fc",
