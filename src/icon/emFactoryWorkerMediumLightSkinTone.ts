...
const definition = {
  icon: import("../webp/emoji_u1f9d1_1f3fc_200d_1f3ed.webp"),
  name: "FactoryWorkerMediumLightSkinTone",
  aliases: ["factory worker: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_1f3fc_200d_1f3ed",
