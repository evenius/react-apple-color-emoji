...
const definition = {
  icon: import("../webp/emoji_u1f477_1f3fc.webp"),
  name: "ConstructionWorkerMediumLightSkinTone",
  aliases: ["construction worker: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f477_1f3fc",
