...
const definition = {
  icon: import("../webp/emoji_u1f6b4_200d_2640_fe0f.webp"),
  name: "WomanBiking",
  aliases: ["woman biking","woman_biking","sports","bike","exercise","hipster","woman","female"],
  width: 160,
  height: 160,
  unicode: "u1f6b4_200d_2640_fe0f",
