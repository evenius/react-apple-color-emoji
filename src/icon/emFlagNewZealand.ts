...
const definition = {
  icon: import("../webp/emoji_u1f1f3_1f1ff.webp"),
  name: "FlagNewZealand",
  aliases: ["flag: New Zealand","flag_new_zealand","new","zealand","flag","nation","country","banner","new_zealand"],
  width: 160,
  height: 160,
  unicode: "u1f1f3_1f1ff",
