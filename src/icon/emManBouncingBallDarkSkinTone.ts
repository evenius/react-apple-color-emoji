...
const definition = {
  icon: import("../webp/emoji_u26f9_1f3ff_200d_2642_fe0f.webp"),
  name: "ManBouncingBallDarkSkinTone",
  aliases: ["man bouncing ball: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u26f9_1f3ff_200d_2642_fe0f",
