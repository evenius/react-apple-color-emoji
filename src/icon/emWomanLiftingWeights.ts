...
const definition = {
  icon: import("../webp/emoji_u1f3cb_fe0f_200d_2640_fe0f.webp"),
  name: "WomanLiftingWeights",
  aliases: ["woman lifting weights","woman_lifting_weights","sports","training","exercise","woman","female"],
  width: 160,
  height: 160,
  unicode: "u1f3cb_fe0f_200d_2640_fe0f",
