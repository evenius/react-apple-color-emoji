...
const definition = {
  icon: import("../webp/emoji_u1f470_1f3ff_200d_2640_fe0f.webp"),
  name: "WomanWithVeilDarkSkinTone",
  aliases: ["woman with veil: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f470_1f3ff_200d_2640_fe0f",
