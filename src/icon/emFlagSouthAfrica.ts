...
const definition = {
  icon: import("../webp/emoji_u1f1ff_1f1e6.webp"),
  name: "FlagSouthAfrica",
  aliases: ["flag: South Africa","flag_south_africa","south","africa","flag","nation","country","banner","south_africa"],
  width: 160,
  height: 160,
  unicode: "u1f1ff_1f1e6",
