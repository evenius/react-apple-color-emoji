...
const definition = {
  icon: import("../webp/emoji_u1f46e_200d_2640_fe0f.webp"),
  name: "WomanPoliceOfficer",
  aliases: ["woman police officer","woman_police_officer","woman","police","law","legal","enforcement","arrest","911","female"],
  width: 160,
  height: 160,
  unicode: "u1f46e_200d_2640_fe0f",
