...
const definition = {
  icon: import("../webp/emoji_u1f46b_1f3ff.webp"),
  name: "WomanAndManHoldingHandsDarkSkinTone",
  aliases: ["woman and man holding hands: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f46b_1f3ff",
