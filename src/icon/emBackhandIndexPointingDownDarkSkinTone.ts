...
const definition = {
  icon: import("../webp/emoji_u1f447_1f3ff.webp"),
  name: "BackhandIndexPointingDownDarkSkinTone",
  aliases: ["backhand index pointing down: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f447_1f3ff",
