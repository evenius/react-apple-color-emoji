...
const definition = {
  icon: import("../webp/emoji_u1f477_200d_2640_fe0f.webp"),
  name: "WomanConstructionWorker",
  aliases: ["woman construction worker","woman_construction_worker","female","human","wip","build","construction","worker","labor","woman"],
  width: 160,
  height: 160,
  unicode: "u1f477_200d_2640_fe0f",
