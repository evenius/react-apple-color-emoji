...
const definition = {
  icon: import("../webp/emoji_u1f93e_1f3fc_200d_2642_fe0f.webp"),
  name: "ManPlayingHandballMediumLightSkinTone",
  aliases: ["man playing handball: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f93e_1f3fc_200d_2642_fe0f",
