...
const definition = {
  icon: import("../webp/emoji_u1f93e_1f3fc.webp"),
  name: "PersonPlayingHandballMediumLightSkinTone",
  aliases: ["person playing handball: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f93e_1f3fc",
