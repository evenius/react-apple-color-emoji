...
const definition = {
  icon: import("../webp/emoji_u1f448_1f3ff.webp"),
  name: "BackhandIndexPointingLeftDarkSkinTone",
  aliases: ["backhand index pointing left: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f448_1f3ff",
