...
const definition = {
  icon: import("../webp/emoji_u1faf7_1f3fc.webp"),
  name: "LeftwardsPushingHandMediumLightSkinTone",
  aliases: ["leftwards pushing hand: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1faf7_1f3fc",
