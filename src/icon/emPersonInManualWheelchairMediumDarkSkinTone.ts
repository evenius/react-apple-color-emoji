...
const definition = {
  icon: import("../webp/emoji_u1f9d1_1f3fe_200d_1f9bd.webp"),
  name: "PersonInManualWheelchairMediumDarkSkinTone",
  aliases: ["person in manual wheelchair: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_1f3fe_200d_1f9bd",
