...
const definition = {
  icon: import("../webp/emoji_u1faf0_1f3fd.webp"),
  name: "HandWithIndexFingerAndThumbCrossedMediumSkinTone",
  aliases: ["hand with index finger and thumb crossed: medium skin tone"],
  width: 160,
  height: 160,
  unicode: "u1faf0_1f3fd",
