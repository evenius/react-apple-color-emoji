...
const definition = {
  icon: import("../webp/emoji_u1faf8_1f3fc.webp"),
  name: "RightwardsPushingHandMediumLightSkinTone",
  aliases: ["rightwards pushing hand: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1faf8_1f3fc",
