...
const definition = {
  icon: import("../webp/emoji_u1f9d5_1f3fc.webp"),
  name: "WomanWithHeadscarfMediumLightSkinTone",
  aliases: ["woman with headscarf: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9d5_1f3fc",
