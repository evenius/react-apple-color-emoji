...
const definition = {
  icon: import("../webp/emoji_u1f9d1_1f3fd_200d_1f9b1.webp"),
  name: "PersonMediumSkinToneCurlyHair",
  aliases: ["person: medium skin tone, curly hair"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_1f3fd_200d_1f9b1",
