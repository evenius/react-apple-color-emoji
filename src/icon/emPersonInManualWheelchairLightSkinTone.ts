...
const definition = {
  icon: import("../webp/emoji_u1f9d1_1f3fb_200d_1f9bd.webp"),
  name: "PersonInManualWheelchairLightSkinTone",
  aliases: ["person in manual wheelchair: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_1f3fb_200d_1f9bd",
