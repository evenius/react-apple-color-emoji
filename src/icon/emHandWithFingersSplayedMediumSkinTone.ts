...
const definition = {
  icon: import("../webp/emoji_u1f590_1f3fd.webp"),
  name: "HandWithFingersSplayedMediumSkinTone",
  aliases: ["hand with fingers splayed: medium skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f590_1f3fd",
