...
const definition = {
  icon: import("../webp/emoji_u1f46b_1f3fd.webp"),
  name: "WomanAndManHoldingHandsMediumSkinTone",
  aliases: ["woman and man holding hands: medium skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f46b_1f3fd",
