...
const definition = {
  icon: import("../webp/emoji_u1f468_1f3fb_200d_1f9af.webp"),
  name: "ManWithWhiteCaneLightSkinTone",
  aliases: ["man with white cane: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f468_1f3fb_200d_1f9af",
