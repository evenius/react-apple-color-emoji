...
const definition = {
  icon: import("../webp/emoji_u1f64b_1f3fc.webp"),
  name: "PersonRaisingHandMediumLightSkinTone",
  aliases: ["person raising hand: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f64b_1f3fc",
