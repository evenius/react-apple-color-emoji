...
const definition = {
  icon: import("../webp/emoji_u1f468_1f3ff_200d_1f9af.webp"),
  name: "ManWithWhiteCaneDarkSkinTone",
  aliases: ["man with white cane: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f468_1f3ff_200d_1f9af",
