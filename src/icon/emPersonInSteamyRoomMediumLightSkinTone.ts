...
const definition = {
  icon: import("../webp/emoji_u1f9d6_1f3fc.webp"),
  name: "PersonInSteamyRoomMediumLightSkinTone",
  aliases: ["person in steamy room: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9d6_1f3fc",
