...
const definition = {
  icon: import("../webp/emoji_u1f9d1_200d_1f9bd.webp"),
  name: "PersonInManualWheelchair",
  aliases: ["person in manual wheelchair","person_in_manual_wheelchair","disability","accessibility"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_200d_1f9bd",
