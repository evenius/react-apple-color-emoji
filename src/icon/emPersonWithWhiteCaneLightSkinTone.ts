...
const definition = {
  icon: import("../webp/emoji_u1f9d1_1f3fb_200d_1f9af.webp"),
  name: "PersonWithWhiteCaneLightSkinTone",
  aliases: ["person with white cane: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_1f3fb_200d_1f9af",
