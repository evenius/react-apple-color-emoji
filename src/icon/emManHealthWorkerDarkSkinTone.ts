...
const definition = {
  icon: import("../webp/emoji_u1f468_1f3ff_200d_2695_fe0f.webp"),
  name: "ManHealthWorkerDarkSkinTone",
  aliases: ["man health worker: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f468_1f3ff_200d_2695_fe0f",
