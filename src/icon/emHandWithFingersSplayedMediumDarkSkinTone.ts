...
const definition = {
  icon: import("../webp/emoji_u1f590_1f3fe.webp"),
  name: "HandWithFingersSplayedMediumDarkSkinTone",
  aliases: ["hand with fingers splayed: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f590_1f3fe",
