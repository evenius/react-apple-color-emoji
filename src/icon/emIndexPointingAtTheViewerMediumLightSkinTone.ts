...
const definition = {
  icon: import("../webp/emoji_u1faf5_1f3fc.webp"),
  name: "IndexPointingAtTheViewerMediumLightSkinTone",
  aliases: ["index pointing at the viewer: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1faf5_1f3fc",
