...
const definition = {
  icon: import("../webp/emoji_u1faf5_1f3ff.webp"),
  name: "IndexPointingAtTheViewerDarkSkinTone",
  aliases: ["index pointing at the viewer: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1faf5_1f3ff",
