...
const definition = {
  icon: import("../webp/emoji_u1f645_1f3fb_200d_2642_fe0f.webp"),
  name: "ManGesturingNOLightSkinTone",
  aliases: ["man gesturing NO: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f645_1f3fb_200d_2642_fe0f",
