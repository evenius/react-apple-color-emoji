...
const definition = {
  icon: import("../webp/emoji_u1f481_1f3fc.webp"),
  name: "PersonTippingHandMediumLightSkinTone",
  aliases: ["person tipping hand: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f481_1f3fc",
