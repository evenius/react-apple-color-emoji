...
const definition = {
  icon: import("../webp/emoji_u1f9d5_1f3fe.webp"),
  name: "WomanWithHeadscarfMediumDarkSkinTone",
  aliases: ["woman with headscarf: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9d5_1f3fe",
