...
const definition = {
  icon: import("../webp/emoji_u1f645_1f3fc.webp"),
  name: "PersonGesturingNOMediumLightSkinTone",
  aliases: ["person gesturing NO: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f645_1f3fc",
