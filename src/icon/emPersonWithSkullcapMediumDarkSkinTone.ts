...
const definition = {
  icon: import("../webp/emoji_u1f472_1f3fe.webp"),
  name: "PersonWithSkullcapMediumDarkSkinTone",
  aliases: ["person with skullcap: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f472_1f3fe",
