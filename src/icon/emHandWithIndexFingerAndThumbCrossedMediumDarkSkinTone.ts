...
const definition = {
  icon: import("../webp/emoji_u1faf0_1f3fe.webp"),
  name: "HandWithIndexFingerAndThumbCrossedMediumDarkSkinTone",
  aliases: ["hand with index finger and thumb crossed: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1faf0_1f3fe",
