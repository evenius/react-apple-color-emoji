...
const definition = {
  icon: import("../webp/emoji_u1f9bb_1f3fc.webp"),
  name: "EarWithHearingAidMediumLightSkinTone",
  aliases: ["ear with hearing aid: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9bb_1f3fc",
