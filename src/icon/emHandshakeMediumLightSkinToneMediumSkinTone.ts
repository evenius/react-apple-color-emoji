...
const definition = {
  icon: import("../webp/emoji_u1faf1_1f3fc_200d_1faf2_1f3fd.webp"),
  name: "HandshakeMediumLightSkinToneMediumSkinTone",
  aliases: ["handshake: medium-light skin tone, medium skin tone"],
  width: 160,
  height: 160,
  unicode: "u1faf1_1f3fc_200d_1faf2_1f3fd",
