...
const definition = {
  icon: import("../webp/emoji_u1f9b9_1f3fb_200d_2642_fe0f.webp"),
  name: "ManSupervillainLightSkinTone",
  aliases: ["man supervillain: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9b9_1f3fb_200d_2642_fe0f",
