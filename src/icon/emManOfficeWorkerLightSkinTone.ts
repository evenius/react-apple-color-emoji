...
const definition = {
  icon: import("../webp/emoji_u1f468_1f3fb_200d_1f4bc.webp"),
  name: "ManOfficeWorkerLightSkinTone",
  aliases: ["man office worker: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f468_1f3fb_200d_1f4bc",
