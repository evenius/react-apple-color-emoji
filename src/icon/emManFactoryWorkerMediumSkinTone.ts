...
const definition = {
  icon: import("../webp/emoji_u1f468_1f3fd_200d_1f3ed.webp"),
  name: "ManFactoryWorkerMediumSkinTone",
  aliases: ["man factory worker: medium skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f468_1f3fd_200d_1f3ed",
