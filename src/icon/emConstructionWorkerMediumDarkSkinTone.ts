...
const definition = {
  icon: import("../webp/emoji_u1f477_1f3fe.webp"),
  name: "ConstructionWorkerMediumDarkSkinTone",
  aliases: ["construction worker: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f477_1f3fe",
