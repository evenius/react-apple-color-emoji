...
const definition = {
  icon: import("../webp/emoji_u1f472_1f3fc.webp"),
  name: "PersonWithSkullcapMediumLightSkinTone",
  aliases: ["person with skullcap: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f472_1f3fc",
