...
const definition = {
  icon: import("../webp/emoji_u1f468_200d_1f9bd.webp"),
  name: "ManInManualWheelchair",
  aliases: ["man in manual wheelchair","man_in_manual_wheelchair","disability","accessibility"],
  width: 160,
  height: 160,
  unicode: "u1f468_200d_1f9bd",
