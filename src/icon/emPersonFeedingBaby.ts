...
const definition = {
  icon: import("../webp/emoji_u1f9d1_200d_1f37c.webp"),
  name: "PersonFeedingBaby",
  aliases: ["person feeding baby","person feeding baby","birth","food"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_200d_1f37c",
