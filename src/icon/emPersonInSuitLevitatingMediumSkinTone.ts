...
const definition = {
  icon: import("../webp/emoji_u1f574_1f3fd.webp"),
  name: "PersonInSuitLevitatingMediumSkinTone",
  aliases: ["person in suit levitating: medium skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f574_1f3fd",
