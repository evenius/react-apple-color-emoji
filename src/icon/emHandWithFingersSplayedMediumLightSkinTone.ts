...
const definition = {
  icon: import("../webp/emoji_u1f590_1f3fc.webp"),
  name: "HandWithFingersSplayedMediumLightSkinTone",
  aliases: ["hand with fingers splayed: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f590_1f3fc",
