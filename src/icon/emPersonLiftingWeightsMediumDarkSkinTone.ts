...
const definition = {
  icon: import("../webp/emoji_u1f3cb_1f3fe.webp"),
  name: "PersonLiftingWeightsMediumDarkSkinTone",
  aliases: ["person lifting weights: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f3cb_1f3fe",
