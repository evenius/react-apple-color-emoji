...
const definition = {
  icon: import("../webp/emoji_u1f64d_1f3ff_200d_2642_fe0f.webp"),
  name: "ManFrowningDarkSkinTone",
  aliases: ["man frowning: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f64d_1f3ff_200d_2642_fe0f",
