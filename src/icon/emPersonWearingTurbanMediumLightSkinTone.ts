...
const definition = {
  icon: import("../webp/emoji_u1f473_1f3fc.webp"),
  name: "PersonWearingTurbanMediumLightSkinTone",
  aliases: ["person wearing turban: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f473_1f3fc",
