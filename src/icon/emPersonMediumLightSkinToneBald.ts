...
const definition = {
  icon: import("../webp/emoji_u1f9d1_1f3fc_200d_1f9b2.webp"),
  name: "PersonMediumLightSkinToneBald",
  aliases: ["person: medium-light skin tone, bald"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_1f3fc_200d_1f9b2",
