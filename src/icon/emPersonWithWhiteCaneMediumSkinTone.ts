...
const definition = {
  icon: import("../webp/emoji_u1f9d1_1f3fd_200d_1f9af.webp"),
  name: "PersonWithWhiteCaneMediumSkinTone",
  aliases: ["person with white cane: medium skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_1f3fd_200d_1f9af",
