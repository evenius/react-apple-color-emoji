...
const definition = {
  icon: import("../webp/emoji_u1f9d1_1f3fc_200d_1f9af.webp"),
  name: "PersonWithWhiteCaneMediumLightSkinTone",
  aliases: ["person with white cane: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_1f3fc_200d_1f9af",
