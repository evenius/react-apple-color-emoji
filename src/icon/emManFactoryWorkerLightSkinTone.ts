...
const definition = {
  icon: import("../webp/emoji_u1f468_1f3fb_200d_1f3ed.webp"),
  name: "ManFactoryWorkerLightSkinTone",
  aliases: ["man factory worker: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f468_1f3fb_200d_1f3ed",
