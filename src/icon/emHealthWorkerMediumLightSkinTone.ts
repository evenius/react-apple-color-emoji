...
const definition = {
  icon: import("../webp/emoji_u1f9d1_1f3fc_200d_2695_fe0f.webp"),
  name: "HealthWorkerMediumLightSkinTone",
  aliases: ["health worker: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_1f3fc_200d_2695_fe0f",
