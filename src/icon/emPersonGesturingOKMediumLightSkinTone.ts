...
const definition = {
  icon: import("../webp/emoji_u1f646_1f3fc.webp"),
  name: "PersonGesturingOKMediumLightSkinTone",
  aliases: ["person gesturing OK: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f646_1f3fc",
