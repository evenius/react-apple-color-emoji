...
const definition = {
  icon: import("../webp/emoji_u1f487_1f3fe.webp"),
  name: "PersonGettingHaircutMediumDarkSkinTone",
  aliases: ["person getting haircut: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f487_1f3fe",
