...
const definition = {
  icon: import("../webp/emoji_u1f446_1f3fc.webp"),
  name: "BackhandIndexPointingUpMediumLightSkinTone",
  aliases: ["backhand index pointing up: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f446_1f3fc",
