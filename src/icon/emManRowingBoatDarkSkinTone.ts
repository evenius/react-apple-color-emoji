...
const definition = {
  icon: import("../webp/emoji_u1f6a3_1f3ff_200d_2642_fe0f.webp"),
  name: "ManRowingBoatDarkSkinTone",
  aliases: ["man rowing boat: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f6a3_1f3ff_200d_2642_fe0f",
