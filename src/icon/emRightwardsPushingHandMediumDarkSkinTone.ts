...
const definition = {
  icon: import("../webp/emoji_u1faf8_1f3fe.webp"),
  name: "RightwardsPushingHandMediumDarkSkinTone",
  aliases: ["rightwards pushing hand: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1faf8_1f3fe",
