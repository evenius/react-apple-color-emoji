...
const definition = {
  icon: import("../webp/emoji_u1f6a3_1f3fb_200d_2640_fe0f.webp"),
  name: "WomanRowingBoatLightSkinTone",
  aliases: ["woman rowing boat: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f6a3_1f3fb_200d_2640_fe0f",
