...
const definition = {
  icon: import("../webp/emoji_u1f9d1_1f3fb_200d_1f9b0.webp"),
  name: "PersonLightSkinToneRedHair",
  aliases: ["person: light skin tone, red hair"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_1f3fb_200d_1f9b0",
