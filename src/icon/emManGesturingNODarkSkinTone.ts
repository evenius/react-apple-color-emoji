...
const definition = {
  icon: import("../webp/emoji_u1f645_1f3ff_200d_2642_fe0f.webp"),
  name: "ManGesturingNODarkSkinTone",
  aliases: ["man gesturing NO: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f645_1f3ff_200d_2642_fe0f",
