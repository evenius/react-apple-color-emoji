...
const definition = {
  icon: import("../webp/emoji_u1f3cb_1f3ff_200d_2640_fe0f.webp"),
  name: "WomanLiftingWeightsDarkSkinTone",
  aliases: ["woman lifting weights: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f3cb_1f3ff_200d_2640_fe0f",
