...
const definition = {
  icon: import("../webp/emoji_u1f6b5_200d_2640_fe0f.webp"),
  name: "WomanMountainBiking",
  aliases: ["woman mountain biking","woman_mountain_biking","transportation","sports","human","race","bike","woman","female"],
  width: 160,
  height: 160,
  unicode: "u1f6b5_200d_2640_fe0f",
