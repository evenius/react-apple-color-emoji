...
const definition = {
  icon: import("../webp/emoji_u1f93d_1f3fd.webp"),
  name: "PersonPlayingWaterPoloMediumSkinTone",
  aliases: ["person playing water polo: medium skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f93d_1f3fd",
