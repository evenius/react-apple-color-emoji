...
const definition = {
  icon: import("../webp/emoji_u1f646_1f3ff_200d_2642_fe0f.webp"),
  name: "ManGesturingOKDarkSkinTone",
  aliases: ["man gesturing OK: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f646_1f3ff_200d_2642_fe0f",
