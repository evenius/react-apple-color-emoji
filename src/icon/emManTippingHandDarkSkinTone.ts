...
const definition = {
  icon: import("../webp/emoji_u1f481_1f3ff_200d_2642_fe0f.webp"),
  name: "ManTippingHandDarkSkinTone",
  aliases: ["man tipping hand: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f481_1f3ff_200d_2642_fe0f",
