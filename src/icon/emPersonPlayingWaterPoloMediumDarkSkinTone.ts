...
const definition = {
  icon: import("../webp/emoji_u1f93d_1f3fe.webp"),
  name: "PersonPlayingWaterPoloMediumDarkSkinTone",
  aliases: ["person playing water polo: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f93d_1f3fe",
