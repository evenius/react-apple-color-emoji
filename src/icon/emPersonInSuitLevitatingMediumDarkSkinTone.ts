...
const definition = {
  icon: import("../webp/emoji_u1f574_1f3fe.webp"),
  name: "PersonInSuitLevitatingMediumDarkSkinTone",
  aliases: ["person in suit levitating: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f574_1f3fe",
