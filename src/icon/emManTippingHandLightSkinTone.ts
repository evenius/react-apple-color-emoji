...
const definition = {
  icon: import("../webp/emoji_u1f481_1f3fb_200d_2642_fe0f.webp"),
  name: "ManTippingHandLightSkinTone",
  aliases: ["man tipping hand: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f481_1f3fb_200d_2642_fe0f",
