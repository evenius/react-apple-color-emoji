...
const definition = {
  icon: import("../webp/emoji_u1f470_1f3fb_200d_2640_fe0f.webp"),
  name: "WomanWithVeilLightSkinTone",
  aliases: ["woman with veil: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f470_1f3fb_200d_2640_fe0f",
