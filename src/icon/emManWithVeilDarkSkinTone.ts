...
const definition = {
  icon: import("../webp/emoji_u1f470_1f3ff_200d_2642_fe0f.webp"),
  name: "ManWithVeilDarkSkinTone",
  aliases: ["man with veil: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f470_1f3ff_200d_2642_fe0f",
