...
const definition = {
  icon: import("../webp/emoji_u1f6a3_200d_2640_fe0f.webp"),
  name: "WomanRowingBoat",
  aliases: ["woman rowing boat","woman_rowing_boat","sports","hobby","water","ship","woman","female"],
  width: 160,
  height: 160,
  unicode: "u1f6a3_200d_2640_fe0f",
