...
const definition = {
  icon: import("../webp/emoji_u1f939_1f3fb_200d_2642_fe0f.webp"),
  name: "ManJugglingLightSkinTone",
  aliases: ["man juggling: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f939_1f3fb_200d_2642_fe0f",
