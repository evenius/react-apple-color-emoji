...
const definition = {
  icon: import("../webp/emoji_u1faf5_1f3fb.webp"),
  name: "IndexPointingAtTheViewerLightSkinTone",
  aliases: ["index pointing at the viewer: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1faf5_1f3fb",
