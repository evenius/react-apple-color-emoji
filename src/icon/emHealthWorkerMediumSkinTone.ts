...
const definition = {
  icon: import("../webp/emoji_u1f9d1_1f3fd_200d_2695_fe0f.webp"),
  name: "HealthWorkerMediumSkinTone",
  aliases: ["health worker: medium skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_1f3fd_200d_2695_fe0f",
