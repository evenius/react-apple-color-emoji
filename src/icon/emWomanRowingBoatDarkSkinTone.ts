...
const definition = {
  icon: import("../webp/emoji_u1f6a3_1f3ff_200d_2640_fe0f.webp"),
  name: "WomanRowingBoatDarkSkinTone",
  aliases: ["woman rowing boat: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f6a3_1f3ff_200d_2640_fe0f",
