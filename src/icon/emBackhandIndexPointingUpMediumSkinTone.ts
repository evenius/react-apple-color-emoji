...
const definition = {
  icon: import("../webp/emoji_u1f446_1f3fd.webp"),
  name: "BackhandIndexPointingUpMediumSkinTone",
  aliases: ["backhand index pointing up: medium skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f446_1f3fd",
