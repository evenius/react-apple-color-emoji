...
const definition = {
  icon: import("../webp/emoji_u1f486_1f3fe.webp"),
  name: "PersonGettingMassageMediumDarkSkinTone",
  aliases: ["person getting massage: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f486_1f3fe",
