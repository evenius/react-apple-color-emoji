...
const definition = {
  icon: import("../webp/emoji_u1f64d_1f3fb_200d_2642_fe0f.webp"),
  name: "ManFrowningLightSkinTone",
  aliases: ["man frowning: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f64d_1f3fb_200d_2642_fe0f",
