...
const definition = {
  icon: import("../webp/emoji_u1f447_1f3fb.webp"),
  name: "BackhandIndexPointingDownLightSkinTone",
  aliases: ["backhand index pointing down: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f447_1f3fb",
