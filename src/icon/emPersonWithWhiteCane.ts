...
const definition = {
  icon: import("../webp/emoji_u1f9d1_200d_1f9af.webp"),
  name: "PersonWithWhiteCane",
  aliases: ["person with white cane","person_with_probing_cane","blind"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_200d_1f9af",
