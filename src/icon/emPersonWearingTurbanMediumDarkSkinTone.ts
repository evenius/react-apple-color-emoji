...
const definition = {
  icon: import("../webp/emoji_u1f473_1f3fe.webp"),
  name: "PersonWearingTurbanMediumDarkSkinTone",
  aliases: ["person wearing turban: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f473_1f3fe",
