...
const definition = {
  icon: import("../webp/emoji_u1f9d6_1f3fe.webp"),
  name: "PersonInSteamyRoomMediumDarkSkinTone",
  aliases: ["person in steamy room: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9d6_1f3fe",
