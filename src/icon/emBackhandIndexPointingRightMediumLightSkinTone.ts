...
const definition = {
  icon: import("../webp/emoji_u1f449_1f3fc.webp"),
  name: "BackhandIndexPointingRightMediumLightSkinTone",
  aliases: ["backhand index pointing right: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f449_1f3fc",
