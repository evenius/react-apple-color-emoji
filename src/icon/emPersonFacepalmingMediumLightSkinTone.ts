...
const definition = {
  icon: import("../webp/emoji_u1f926_1f3fc.webp"),
  name: "PersonFacepalmingMediumLightSkinTone",
  aliases: ["person facepalming: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f926_1f3fc",
