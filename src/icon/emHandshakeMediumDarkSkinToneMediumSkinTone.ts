...
const definition = {
  icon: import("../webp/emoji_u1faf1_1f3fe_200d_1faf2_1f3fd.webp"),
  name: "HandshakeMediumDarkSkinToneMediumSkinTone",
  aliases: ["handshake: medium-dark skin tone, medium skin tone"],
  width: 160,
  height: 160,
  unicode: "u1faf1_1f3fe_200d_1faf2_1f3fd",
