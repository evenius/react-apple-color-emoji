...
const definition = {
  icon: import("../webp/emoji_u1f9d1_1f3fb_200d_2695_fe0f.webp"),
  name: "HealthWorkerLightSkinTone",
  aliases: ["health worker: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_1f3fb_200d_2695_fe0f",
