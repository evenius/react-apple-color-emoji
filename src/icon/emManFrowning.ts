...
const definition = {
  icon: import("../webp/emoji_u1f64d_200d_2642_fe0f.webp"),
  name: "ManFrowning",
  aliases: ["man frowning","man_frowning","male","boy","man","sad","depressed","discouraged","unhappy"],
  width: 160,
  height: 160,
  unicode: "u1f64d_200d_2642_fe0f",
