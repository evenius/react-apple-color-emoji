...
// Emoji definition for ChildrenCrossing
import type { AppleIconDefinition } from "../index.js";

const definition = {
  icon: import("../webp/emoji_u1f6b8.webp"),
  name: "ChildrenCrossing",
  aliases: ["children crossing","children_crossing","school","warning","danger","sign","driving","yellow-diamond"],
  width: 160,
  height: 160,
  unicode: "u1f6b8",
