...
const definition = {
  icon: import("../webp/emoji_u1f448_1f3fb.webp"),
  name: "BackhandIndexPointingLeftLightSkinTone",
  aliases: ["backhand index pointing left: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f448_1f3fb",
