...
const definition = {
  icon: import("../webp/emoji_u1f574_1f3fc.webp"),
  name: "PersonInSuitLevitatingMediumLightSkinTone",
  aliases: ["person in suit levitating: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f574_1f3fc",
