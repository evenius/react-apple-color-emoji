...
const definition = {
  icon: import("../webp/emoji_u1f93e_1f3fb_200d_2640_fe0f.webp"),
  name: "WomanPlayingHandballLightSkinTone",
  aliases: ["woman playing handball: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f93e_1f3fb_200d_2640_fe0f",
