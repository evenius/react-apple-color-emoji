...
const definition = {
  icon: import("../webp/emoji_u1f938_1f3fc.webp"),
  name: "PersonCartwheelingMediumLightSkinTone",
  aliases: ["person cartwheeling: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f938_1f3fc",
