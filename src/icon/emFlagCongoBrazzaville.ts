...
const definition = {
  icon: import("../webp/emoji_u1f1e8_1f1ec.webp"),
  name: "FlagCongoBrazzaville",
  aliases: ["flag: Congo - Brazzaville","flag_congo_brazzaville","congo","flag","nation","country","banner","congo_brazzaville"],
  width: 160,
  height: 160,
  unicode: "u1f1e8_1f1ec",
