...
const definition = {
  icon: import("../webp/emoji_u1f64b_1f3fb_200d_2642_fe0f.webp"),
  name: "ManRaisingHandLightSkinTone",
  aliases: ["man raising hand: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f64b_1f3fb_200d_2642_fe0f",
