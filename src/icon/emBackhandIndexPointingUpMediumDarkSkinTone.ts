...
const definition = {
  icon: import("../webp/emoji_u1f446_1f3fe.webp"),
  name: "BackhandIndexPointingUpMediumDarkSkinTone",
  aliases: ["backhand index pointing up: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f446_1f3fe",
