...
const definition = {
  icon: import("../webp/emoji_u1f447_1f3fc.webp"),
  name: "BackhandIndexPointingDownMediumLightSkinTone",
  aliases: ["backhand index pointing down: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f447_1f3fc",
