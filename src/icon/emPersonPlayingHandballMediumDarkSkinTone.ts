...
const definition = {
  icon: import("../webp/emoji_u1f93e_1f3fe.webp"),
  name: "PersonPlayingHandballMediumDarkSkinTone",
  aliases: ["person playing handball: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f93e_1f3fe",
