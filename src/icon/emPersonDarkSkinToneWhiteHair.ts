...
const definition = {
  icon: import("../webp/emoji_u1f9d1_1f3ff_200d_1f9b3.webp"),
  name: "PersonDarkSkinToneWhiteHair",
  aliases: ["person: dark skin tone, white hair"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_1f3ff_200d_1f9b3",
