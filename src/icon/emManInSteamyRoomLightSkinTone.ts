...
const definition = {
  icon: import("../webp/emoji_u1f9d6_1f3fb_200d_2642_fe0f.webp"),
  name: "ManInSteamyRoomLightSkinTone",
  aliases: ["man in steamy room: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9d6_1f3fb_200d_2642_fe0f",
