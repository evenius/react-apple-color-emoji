...
const definition = {
  icon: import("../webp/emoji_u1f93d_200d_2642_fe0f.webp"),
  name: "ManPlayingWaterPolo",
  aliases: ["man playing water polo","man_playing_water_polo","sports","pool"],
  width: 160,
  height: 160,
  unicode: "u1f93d_200d_2642_fe0f",
