...
const definition = {
  icon: import("../webp/emoji_u1f1f9_1f1f1.webp"),
  name: "FlagTimorLeste",
  aliases: ["flag: Timor-Leste","flag_timor_leste","timor","leste","flag","nation","country","banner","timor_leste"],
  width: 160,
  height: 160,
  unicode: "u1f1f9_1f1f1",
