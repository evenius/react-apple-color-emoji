...
const definition = {
  icon: import("../webp/emoji_u1f9d1_1f3fc_200d_1f9bc.webp"),
  name: "PersonInMotorizedWheelchairMediumLightSkinTone",
  aliases: ["person in motorized wheelchair: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_1f3fc_200d_1f9bc",
