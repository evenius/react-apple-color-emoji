...
const definition = {
  icon: import("../webp/emoji_u1faf7_1f3fe.webp"),
  name: "LeftwardsPushingHandMediumDarkSkinTone",
  aliases: ["leftwards pushing hand: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1faf7_1f3fe",
