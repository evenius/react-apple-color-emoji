...
const definition = {
  icon: import("../webp/emoji_u1f938_1f3fe.webp"),
  name: "PersonCartwheelingMediumDarkSkinTone",
  aliases: ["person cartwheeling: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f938_1f3fe",
