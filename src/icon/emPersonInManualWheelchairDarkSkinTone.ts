...
const definition = {
  icon: import("../webp/emoji_u1f9d1_1f3ff_200d_1f9bd.webp"),
  name: "PersonInManualWheelchairDarkSkinTone",
  aliases: ["person in manual wheelchair: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9d1_1f3ff_200d_1f9bd",
