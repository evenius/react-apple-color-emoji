...
const definition = {
  icon: import("../webp/emoji_u1f938_200d_2642_fe0f.webp"),
  name: "ManCartwheeling",
  aliases: ["man cartwheeling","man_cartwheeling","gymnastics"],
  width: 160,
  height: 160,
  unicode: "u1f938_200d_2642_fe0f",
