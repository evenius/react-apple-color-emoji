...
const definition = {
  icon: import("../webp/emoji_u1f9bb_1f3fe.webp"),
  name: "EarWithHearingAidMediumDarkSkinTone",
  aliases: ["ear with hearing aid: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9bb_1f3fe",
