...
const definition = {
  icon: import("../webp/emoji_u1f448_1f3fe.webp"),
  name: "BackhandIndexPointingLeftMediumDarkSkinTone",
  aliases: ["backhand index pointing left: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f448_1f3fe",
