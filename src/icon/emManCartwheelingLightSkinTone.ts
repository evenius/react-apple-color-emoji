...
const definition = {
  icon: import("../webp/emoji_u1f938_1f3fb_200d_2642_fe0f.webp"),
  name: "ManCartwheelingLightSkinTone",
  aliases: ["man cartwheeling: light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f938_1f3fb_200d_2642_fe0f",
