...
const definition = {
  icon: import("../webp/emoji_u1f487_1f3fc.webp"),
  name: "PersonGettingHaircutMediumLightSkinTone",
  aliases: ["person getting haircut: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f487_1f3fc",
