...
const definition = {
  icon: import("../webp/emoji_u1f91a_1f3fc.webp"),
  name: "RaisedBackOfHandMediumLightSkinTone",
  aliases: ["raised back of hand: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f91a_1f3fc",
