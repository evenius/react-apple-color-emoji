...
const definition = {
  icon: import("../webp/emoji_u1f1f3_1f1e8.webp"),
  name: "FlagNewCaledonia",
  aliases: ["flag: New Caledonia","flag_new_caledonia","new","caledonia","flag","nation","country","banner","new_caledonia"],
  width: 160,
  height: 160,
  unicode: "u1f1f3_1f1e8",
