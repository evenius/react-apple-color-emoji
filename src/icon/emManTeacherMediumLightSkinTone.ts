...
const definition = {
  icon: import("../webp/emoji_u1f468_1f3fc_200d_1f3eb.webp"),
  name: "ManTeacherMediumLightSkinTone",
  aliases: ["man teacher: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f468_1f3fc_200d_1f3eb",
