...
const definition = {
  icon: import("../webp/emoji_u1f9db_1f3ff_200d_2642_fe0f.webp"),
  name: "ManVampireDarkSkinTone",
  aliases: ["man vampire: dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f9db_1f3ff_200d_2642_fe0f",
