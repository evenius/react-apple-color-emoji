...
const definition = {
  icon: import("../webp/emoji_u1f46b_1f3fe.webp"),
  name: "WomanAndManHoldingHandsMediumDarkSkinTone",
  aliases: ["woman and man holding hands: medium-dark skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f46b_1f3fe",
