...
const definition = {
  icon: import("../webp/emoji_u1f1f9_1f1f2.webp"),
  name: "FlagTurkmenistan",
  aliases: ["flag: Turkmenistan","flag_turkmenistan","flag","nation","country","banner","turkmenistan"],
  width: 160,
  height: 160,
  unicode: "u1f1f9_1f1f2",
