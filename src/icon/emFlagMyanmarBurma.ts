...
const definition = {
  icon: import("../webp/emoji_u1f1f2_1f1f2.webp"),
  name: "FlagMyanmarBurma",
  aliases: ["flag: Myanmar (Burma)","flag_myanmar","mm","flag","nation","country","banner","myanmar"],
  width: 160,
  height: 160,
  unicode: "u1f1f2_1f1f2",
