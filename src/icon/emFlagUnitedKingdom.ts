...
const definition = {
  icon: import("../webp/emoji_u1f1ec_1f1e7.webp"),
  name: "FlagUnitedKingdom",
  aliases: ["flag: United Kingdom","flag_united_kingdom","united","kingdom","great","britain","northern","ireland","flag","nation","country","banner","british","UK","english","england","union jack","united_kingdom"],
  width: 160,
  height: 160,
  unicode: "u1f1ec_1f1e7",
