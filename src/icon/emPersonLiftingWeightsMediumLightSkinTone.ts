...
const definition = {
  icon: import("../webp/emoji_u1f3cb_1f3fc.webp"),
  name: "PersonLiftingWeightsMediumLightSkinTone",
  aliases: ["person lifting weights: medium-light skin tone"],
  width: 160,
  height: 160,
  unicode: "u1f3cb_1f3fc",
