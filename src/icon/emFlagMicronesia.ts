...
const definition = {
  icon: import("../webp/emoji_u1f1eb_1f1f2.webp"),
  name: "FlagMicronesia",
  aliases: ["flag: Micronesia","flag_micronesia","micronesia","federated","states","flag","nation","country","banner","micronesia"],
  width: 160,
  height: 160,
  unicode: "u1f1eb_1f1f2",
