...
const definitionInfo: [normalName: string, definitionFile: string][] = [];
...
emojiList.forEach(emoji => {
  ...
  const emojiDefinitionFile = emojiDefinitionFileTemplate(normalisedAlias, aliases, fileName, "u" + utf16, 160, 160);
  emojiDefinitions.push(
    [aliasEmojiType, aliasEmojiName]
  )

  definitionInfo.push(
    [normalisedAlias, emojiDefinitionFile]
  )
})
